...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs VA Shitpost Team'],
			['VA Shitpost', 		'va', 				'Director, Artist, Charter and Coder',						'https://www.youtube.com/channel/UCTn1nJJmShKqAo7Mm5AO-HQ', '00FFFF'],
			...
			['NoBoi', 				'noboi',			'Old VA Sprites', 											'https://www.youtube.com/channel/UCSWuDxrJriSG3lDM1T9uuIA', 'FEBD2D'],
			['FakeZackDroid', 		'fakezackdroid',	'VA Background', 											'https://www.youtube.com/channel/UCGyGGVeln0wAOVmyt7W38hQ', '55FF00'],
			[''],
			['Psych Engine Team'],
